...
public class ViewPharmacyCoordinatesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pharmacy_coordinates);
        ...
        RecyclerView recyclerView = findViewById(R.id.pharmacy_coordinates_recycler);
    ...
    public void getCoordinates(){
        ...
        String network_address = helperFunctions.getIpAddress() + "get_pharmacies_locations_pharmacist.php?id=" + preferenceManager.getPsuId();
