...
public class ViewPharmacistAssessmentFormActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_pharmacist_assessment_form);
        ...
        // TextView
        pharmacy_name = findViewById(R.id.view_pharmacist_assessment_pharmacy_name);
        pharmacist_name = findViewById(R.id.view_pharmacist_assessment_pharmacist_name);
        appraiser_name = findViewById(R.id.view_pharmacist_assessment_appraiser_name);
        appraiser_title = findViewById(R.id.view_pharmacist_assessment_appraiser_title);
        from_period = findViewById(R.id.view_pharmacist_assessment_from_period);
        to_period = findViewById(R.id.view_pharmacist_assessment_to_period);
        score_one = findViewById(R.id.view_pharmacist_assessment_score_one);
        score_two = findViewById(R.id.view_pharmacist_assessment_score_two);
        score_three = findViewById(R.id.view_pharmacist_assessment_score_three);
        score_four = findViewById(R.id.view_pharmacist_assessment_score_four);
        score_five = findViewById(R.id.view_pharmacist_assessment_score_five);
        remarks = findViewById(R.id.view_pharmacist_assessment_remarks);
