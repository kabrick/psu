...
public class NdaAdminNewsFragment extends Fragment implements NewsFeedAdapter.NewsFeedAdapterListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_nda_admin_news, container, false);

        RecyclerView recyclerView = view.findViewById(R.id.recycler_view_nda_admin_news);
        newsList = new ArrayList<>();
        mAdapter = new NewsFeedAdapter(getContext(), newsList, this);

        progressBar = view.findViewById(R.id.progressBarAdminNews);

        fab = view.findViewById(R.id.nda_admin_add_news_fab);
