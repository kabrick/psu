...
$sql = "INSERT INTO psu_supervision_checklist_wholesale (additional_notes, pharmacy_name, contact_name, contact, supervising_pharmacist, reg_number, support_supervision_date, location, section_a_checklist, section_b_checklist, submitted_by, timestamp) VALUES ('$additional_notes','$pharmacy_name','$contact_name','$contact','$supervising_pharmacist','$reg_number','$support_supervision_date','$location','$section_a_checklist','$section_b_checklist','$submitted_by','$timestamp')";
